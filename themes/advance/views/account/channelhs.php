...
<body>
    <div id="tpl-contaiter">
        <div class="sign-main">
            <div class="sign-form">
                <div class="sign-logo">
                    <a href="#" style="font-family: font-dep"  data-toggle="modal" data-target="#myModal6" ><img src="<?php echo Yii::app()->theme->baseUrl ?>/img/logo2.png" /></a>
                </div>
                <div class="sign-logo">
                ...
                <div class="sign-input">
                    <form action="<?php echo $this->createUrl("/account/login"); ?>" method="post">
                        ...
                        <div class="row" style="margin-top: 10px">
                            <a type="submit" href="https://facebook.com/dialog/oauth?client_id=1054223384618565&redirect_uri=https://www.hocde.vn/account/channelloginface" class="sign-submit"><img width="60%" src="<?php echo Yii::app()->theme->baseUrl ?>/img/dangnhapfb.png" /> </a>
                        </div>
                       <!--<a href="https://accounts.google.com/o/oauth2/auth?response_type=code&redirect_uri=http%3A%2F%2Fhocde.onedu.vn%2Faccount%2FloginGoogle&client_id=416965466359-5ic1landcm6r2tonkchmnrkiu0ukfqlh.apps.googleusercontent.com&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fplus.login+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fplus.me&access_type=offline&approval_prompt=auto" class="btn btn-default sign-submit">Google Plus</a>-->
                    </form>
<!--                    <form action="#" method="post">
                        <div class="row" style="margin-top: 10px">
                            <a type="submit" href="https://facebook.com/dialog/oauth?client_id=1054223384618565&redirect_uri=http://hocde.onedu.vn/account/channelloginface" class="sign-submit"><img width="60%" src="<?php echo Yii::app()->theme->baseUrl ?>/img/dangnhapfb.png" /> </a>
                        </div>
                    </form>-->
                ...
                <div class="sign-more">
                    ...
                    <a href="#"style="font-family: font-dep"  data-toggle="modal" data-target="#myModal6">Đăng ký</a><br/>
