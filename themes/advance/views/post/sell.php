...
<form enctype="multipart/form-data" id="formUpload" action="" method="post" data-ajax="false">
    ...
    <div class="form-group">
        <label>Hãng xe</label>
        <input type="text" name="branch" id="branch" placeholder="Hãng xe ..." />
    </div>
    ...
    <div class="form-group">
        <label>Nơi bán</label>
        <input type="text" name="address" id="address" placeholder="Nơi bán" />
    </div>
    ...
    <div class="form-group">
        <label>Mô tả</label>
        <textarea type="text" name="message" id="message" placeholder="Bắt buộc (không quá 500 kí tự)" >
        </textarea>
    </div>
