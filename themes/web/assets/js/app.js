var App = function () {
    ...
    var handleClockfaceTimePickers = function () {
        ...
        $('.clockface_21').clockface({
            format: 'HH:mm',
            trigger: 'manual'
        });
        $('.clockface_22').clockface({
            format: 'HH:mm',
            trigger: 'manual'
        });

        $('.clockface_2_toggle-btn1').click(function (e) {
            e.stopPropagation();
            $('.clockface_21').clockface('toggle');
        });
        $('.clockface_2_toggle-btn2').click(function (e) {
            e.stopPropagation();
            $('.clockface_22').clockface('toggle');
        });
